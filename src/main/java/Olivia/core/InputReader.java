 ...
 *
 * @author oscar.garcia
 * @param <VM> In case it only works with a particular VisualisationManager
 */
public abstract class InputReader<VM extends VisualisationManager> {
    ...
    /**
     * Tries to guess the delimiter on a line, between "\t", " " and ",", the one that gets more than one column when splitting the line is selected
     * @param line The line used to guess the delimiter
     * @return The guessed delimiter or an empty String if it could not be guessed
     */
     ...
     * @param visualisationManager The visualisationManager to store the data
     * @throws FileNotFoundException If file not found
     * @throws IOException If there is an error reading IO
     */
    public abstract void readFromFiles(String filePath, VM visualisationManager) throws FileNotFoundException, IOException;
